...
namespace SchoolAPI.Migrations
{
    ...
    [Migration("20260704164231_Payment_EnumFix_Schedule_NullableFKs_IsFreePeriod")]
    partial class Payment_EnumFix_Schedule_NullableFKs_IsFreePeriod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
                    ...
                    b.ToTable("Schedules", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CHK_FREEPERIOD_NO_SUBJECT", "[IsFreePeriod] = 0 OR [SubjectId] IS NULL");

                            t.HasCheckConstraint("CHK_FREEPERIOD_NO_TEACHER", "[IsFreePeriod] = 0 OR [TeacherId] IS NULL");

                            t.HasCheckConstraint("CHK_STARTTIME_BEFORE_ENDTIME", "[StartTime] < [EndTime]");

                            t.HasCheckConstraint("CHK_SUBJECT_REQUIRES_TEACHER", "[IsFreePeriod] = 1 OR ([SubjectId] IS NOT NULL AND [TeacherId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("SchoolAPI.Models.SubjectAndBridge.ClassSubject", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("SchoolAPI.Models.SubjectAndBridge.Subject", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("SchoolAPI.Models.SubjectAndBridge.TeacherSubjectClass", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(50)");
                    ...
                    b.HasIndex("ClassSubjectId", "TeacherId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SchoolAPI.Models.Schedules.Schedule", b =>
                {
                    ...
                    b.HasOne("SchoolAPI.Models.SubjectAndBridge.Subject", "Subject")
                        .WithMany("Schedules")
            ...
            modelBuilder.Entity("SchoolAPI.Models.SubjectAndBridge.TeacherSubjectClass", b =>
                {
                    b.HasOne("SchoolAPI.Models.SubjectAndBridge.ClassSubject", "ClassSubject")
                        .WithMany("TeacherSubjectClasses")
                        .HasForeignKey("ClassSubjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolAPI.Models.SubjectAndBridge.Subject", null)
                        .WithMany("TeacherSubjectClasses")
                        .HasForeignKey("SubjectId");
