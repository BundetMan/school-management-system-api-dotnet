...
public class SchoolDbContext(DbContextOptions<SchoolDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Schedule>(buildAction =>
        {
            ...
            // Ensure a teacher cannot have overlapping schedules and a class cannot have overlapping schedules
            buildAction.HasIndex(s => new { s.ClassId, s.Day, s.StartTime }).IsUnique();
            buildAction.HasIndex(s => new { s.TeacherId, s.Day, s.StartTime }).IsUnique();
